...
describe('SearchBar', () => {
    ...
    it('renders input and button', () => {
        render(<SearchBar value="" onValueChange={() => {}} onSearchClick={() => {}} />);
    ...
    it('calls onSearchClick when search button is clicked', () => {
        ...
        render(<SearchBar value="" onValueChange={() => {}} onSearchClick={handleSearchClick} />);
        fireEvent.click(screen.getByText('Search'));
        expect(handleSearchClick).toHaveBeenCalled();
    });

    it('displays the correct value in the input', () => {
        render(<SearchBar value="Inception" onValueChange={() => {}} onSearchClick={() => {}} />);
